...
const members = [
  { 
    ...
    role: 'Líder - Rapper', 
    profileUrl: 'https://bangtannow.com/perfil-kim-namjoon/',
  ...
  { 
    ...
    role: 'Vocalista', 
    profileUrl: 'https://bangtannow.com/perfil-kim-seokjin/',
  ...
  { 
    id: 'suga', 
    name: 'SUGA', 
    realName: 'Min Yoongi / Agust D', 
    role: 'Rapper', 
    profileUrl: 'https://bangtannow.com/perfil-min-yoongi/',
  ...
  { 
    ...
    role: 'Rapper', 
    profileUrl: 'https://bangtannow.com/perfil-jung-hoseok/',
  ...
  { 
    ...
    realName: 'Park Jimin', 
    role: 'Vocalista', 
    profileUrl: 'https://bangtannow.com/perfil-park-jimin/',
  ...
  { 
    ...
    role: 'Vocalista', 
    profileUrl: 'https://bangtannow.com/perfil-kim-taehyung/',
  ...
  { 
    ...
    role: 'Vocalista', 
    profileUrl: 'https://bangtannow.com/perfil-jeon-jungkook/',
...
const AboutBTS: React.FC<{ theme: Theme }> = ({ theme }) => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-12 pb-24 reveal-animation px-4">
      <div className="relative rounded-xl overflow-hidden shadow-2xl border-2 border-purple-500/10 max-w-4xl mx-auto aspect-video md:aspect-auto">
      ...
      <div className={`max-w-4xl mx-auto space-y-8 p-8 md:p-12 rounded-xl border-2 ${currentColors.card} ${currentColors.border} shadow-xl`}>
        <div className="space-y-6 text-base md:text-lg leading-relaxed font-medium">
          ...
          <div className={`p-6 rounded-xl bg-purple-500/5 border border-purple-500/10 space-y-4 ${currentColors.text}`}>
            <p className="font-bold">Cada membro traz uma col únicos a essa história:</p>
            <ul className="space-y-4 opacity-90">
              ...
              <li className="flex gap-3"><span>🐻</span> <span><strong>V</strong>, com sua arte e autenticidade, nos inspira a ser quem somos sem medo.</span></li>
              <li className="flex gap-3"><span>🐰</span> <span><strong>Jungkook</strong>, com sua dedicação e paixão, representa o desejo constante de evoluir e dar o melhor de si.</span></li>
            </ul>
          </div>
          <p className={currentColors.text}>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
        {members.map(m => (
          <div key={m.id} className={`p-6 rounded-xl border-2 ${currentColors.card} ${currentColors.border} shadow-lg text-center transition-transform hover:scale-105 group`}>
            ...
            <a 
              ...
              className="text-[10px] text-purple-500 font-bold uppercase tracking-widest hover:underline block"
            >
              {m.realName}
            </a>
            
            <p className={`text-[9px] uppercase font-medium opacity-60 mb-4 ${currentColors.text}`}>
              {m.role}
            </p>

            <div className="flex justify-center gap-2">
              <a href={m.instagramUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center p-2 rounded-full bg-purple-500/10 text-purple-500 hover:bg-purple-500 hover:text-white transition-all shadow-sm">
              ...
              {m.spotifyUrls.map((url, index) => (
                <a key={index} href={url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center p-2 rounded-full bg-purple-100 text-[#a855f7] hover:bg-[#a855f7] hover:text-white transition-all shadow-sm">
                  <SpotifyIcon />
                </a>
              ))}
            </div>
